...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|Motor_In_3_Pin|Motor_In_4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Motor_In_1_Pin|Motor_In_2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin Motor_In_3_Pin Motor_In_4_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|Motor_In_3_Pin|Motor_In_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : Motor_In_1_Pin Motor_In_2_Pin */
  GPIO_InitStruct.Pin = Motor_In_1_Pin|Motor_In_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
    ...
    {
        MinicarCanRx(&state, rx_header, rx_data);
    }
}
